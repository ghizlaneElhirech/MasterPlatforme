...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>@lang('results.fields.result')</th>
            ...
            <a href="{{ route('tests.index') }}" class="btn btn-info">Take another quiz</a>
            <a href="{{ route('results.index') }}" class="btn btn-primary">See all my results</a>
        </div>
    </div>
@stop
