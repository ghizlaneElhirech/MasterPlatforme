...
@section('content')
    ...
    <p>
        <a href="{{ route('questions_options.create') }}" class="btn btn-success">add_new</a>
    </p>
            ...
            <table class="table table-bordered table-striped {{ count($questions_options) > 0 ? 'datatable' : '' }} dt-select">
                <thead>
                    <tr>
                        ...
                        <th>questions-options.fields.question</th>
                        <th>questions-options.fields.option</th>
                        <th>questions-options.fields.correct')</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
