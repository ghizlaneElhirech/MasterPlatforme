...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr><th>questions.fields.topic</th>
                    <td>{{ $question->topic->title or '' }}</td></tr><tr><th>questions.fields</th>
            ...
            <a href="{{ route('questions.index') }}" class="btn btn-default">back_to_list</a>
        </div>
    </div>
@stop