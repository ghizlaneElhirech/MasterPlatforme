        ...
        <div class="card-body">
            ...
            <br><br>
                ...
                <form action="{{ route('Filter_Classes') }}" method="POST">
                    {{ csrf_field() }}
                    <select class="selectpicker" data-style="btn-info" name="semestre_id" required
                    ...
                    @endif
                        ...
                        @foreach ($List_Classes as $My_Class)
                            <tr>
                                ...
                                <td>{{ $My_Class->semestres->semestre_name }}</td>
                                <td>
                                            ...
                                            <form action="{{ route('Classrooms.update', 'test') }}" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-lg"
                                                            id="exampleFormControlSelect1" name="semestre_id">
                                                        <option value="{{ $My_Class->semestres->id }}">
                                                            {{ $My_Class->semestres->semestre_name }}
                                                        </option>
                                                        @foreach ($semestres as $semestre)
                                ...
                                <div data-repeater-item>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="box">
                                                <select class="fancyselect" name="semestre_id">
                                                    @foreach ($semestres as $semestre)
                                                        <option value="{{ $semestre->id }}">{{ $semestre->semestre_name }}</option>
                                                    @endforeach
                                                </select>
